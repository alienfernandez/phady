...
PHP_METHOD(Phady_Core_Kernel, readConfigFiles) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "extension_loaded", NULL, 6, &_2);
	zephir_check_call_status();
	if (!zephir_is_true(_3)) {
	...
	ZEPHIR_CALL_CE_STATIC(&_4, phady_config_yaml_ce, "parse", &_5, 7, configFile);
	zephir_check_call_status();
	zephir_update_property_this(this_ptr, SL("config"), _4 TSRMLS_CC);
	ZEPHIR_CALL_CE_STATIC(&_6, phady_config_yaml_ce, "parse", &_5, 7, securityFile);
	zephir_check_call_status();
...
PHP_METHOD(Phady_Core_Kernel, initializeNamespace) {
	...
	ZEPHIR_CALL_METHOD(NULL, nsCore, "__construct", NULL, 8, _0, _1, _2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, nsCore, "getallnamespaceapp", NULL, 9);
	zephir_check_call_status();
...
PHP_METHOD(Phady_Core_Kernel, initializeDefaultService) {
	...
	int _1, _3, _5, _7, ZEPHIR_LAST_CALL_STATUS;
	zval *di, *config = NULL, *_0, *_SERVER, *_2, *_4, *_6, *_8, *_9, *_10 = NULL, *_11 = NULL, *_12, *_13 = NULL, *_14, *_15 = NULL, *_16 = NULL, *_17, *_18, *_19 = NULL, *_20, *_21 = NULL, *_22, *_23 = NULL, *_24, *_25;
	...
	_6 = zephir_fetch_nproperty_this(this_ptr, SL("container"), PH_NOISY_CC);
	_7 = zephir_maybe_separate_zval(&_SERVER);
	zephir_array_update_string(&_SERVER, SL("containerApp"), &_6, PH_COPY | PH_SEPARATE);
	if (_7) {
		ZEND_SET_SYMBOL(&EG(symbol_table), "_SERVER", _SERVER);
	}
	...
	if (ZEPHIR_IS_STRING(_8, "mvc")) {
		...
		zephir_create_closure_ex(_10, NULL, phady_0__closure_ce, SS("__invoke") TSRMLS_CC);
		ZEPHIR_INIT_VAR(_11);
		ZVAL_STRING(_11, "router", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _9, "set", NULL, 0, _11, _10);
		zephir_check_temp_parameter(_11);
		zephir_check_call_status();
		_12 = zephir_fetch_nproperty_this(this_ptr, SL("container"), PH_NOISY_CC);
		ZEPHIR_INIT_NVAR(_11);
		ZEPHIR_INIT_NVAR(_11);
		zephir_create_closure_ex(_11, NULL, phady_1__closure_ce, SS("__invoke") TSRMLS_CC);
		ZEPHIR_INIT_VAR(_13);
		ZVAL_STRING(_13, "dispatcher", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _12, "setshared", NULL, 0, _13, _11);
	...
	ZEPHIR_INIT_NVAR(_11);
	ZVAL_STRING(_11, "db", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _9, "set", NULL, 0, _11, _10);
	zephir_check_temp_parameter(_11);
	zephir_check_call_status();
	_12 = zephir_fetch_nproperty_this(this_ptr, SL("container"), PH_NOISY_CC);
	ZEPHIR_INIT_NVAR(_11);
	ZEPHIR_INIT_NVAR(_11);
	zephir_create_closure_ex(_11, NULL, phady_3__closure_ce, SS("__invoke") TSRMLS_CC);
	ZEPHIR_INIT_NVAR(_13);
	ZVAL_STRING(_13, "view", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _12, "set", NULL, 0, _13, _11);
	zephir_check_temp_parameter(_13);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(_15);
	ZVAL_STRING(_15, "volt", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_INIT_VAR(_16);
	ZVAL_BOOL(_16, 1);
	ZEPHIR_CALL_METHOD(NULL, _14, "set", NULL, 0, _15, _13, _16);
	...
	ZVAL_STRING(_16, "flash", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _17, "set", NULL, 0, _16, _15);
	...
	ZEPHIR_INIT_VAR(_19);
	ZVAL_STRING(_19, "parameters", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _18, "set", NULL, 0, _19, _16);
	zephir_check_temp_parameter(_19);
	zephir_check_call_status();
	_20 = zephir_fetch_nproperty_this(this_ptr, SL("container"), PH_NOISY_CC);
	ZEPHIR_INIT_NVAR(_19);
	ZEPHIR_INIT_NVAR(_19);
	zephir_create_closure_ex(_19, NULL, phady_7__closure_ce, SS("__invoke") TSRMLS_CC);
	ZEPHIR_INIT_VAR(_21);
	ZVAL_STRING(_21, "cache", ZEPHIR_TEMP_PARAM_COPY);
	...
	ZEPHIR_INIT_NVAR(_21);
	zephir_create_closure_ex(_21, NULL, phady_8__closure_ce, SS("__invoke") TSRMLS_CC);
	ZEPHIR_INIT_VAR(_23);
	ZVAL_STRING(_23, "cookies", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _22, "set", NULL, 0, _23, _21);
	zephir_check_temp_parameter(_23);
	zephir_check_call_status();
	_24 = zephir_fetch_nproperty_this(this_ptr, SL("container"), PH_NOISY_CC);
	ZEPHIR_INIT_NVAR(_23);
	ZEPHIR_INIT_NVAR(_23);
	zephir_create_closure_ex(_23, NULL, phady_9__closure_ce, SS("__invoke") TSRMLS_CC);
	ZEPHIR_INIT_VAR(_25);
	ZVAL_STRING(_25, "loginManager", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, _24, "set", NULL, 0, _25, _23);
...
PHP_METHOD(Phady_Core_Kernel, getCoreParameters) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "phady/core/kernel.zep", 393);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		ZEPHIR_GET_HVALUE(module, _3);
		zephir_is_iterable(module, &_5, &_4, 0, 0, "phady/core/kernel.zep", 392);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_5, &_4)
			...
			zephir_array_fetch_string(&_7, data, SL("className"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 390 TSRMLS_CC);
	...
	_8 = zephir_fetch_nproperty_this(this_ptr, SL("scope"), PH_NOISY_CC);
	if (ZEPHIR_IS_STRING(_8, "mvc")) {
		ZEPHIR_CALL_METHOD(&_9, tools, "gethttphost", NULL, 10);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_10);
		ZVAL_STRING(_10, "http_host", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _9);
		zephir_check_temp_parameter(_10);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_11, tools, "getrequestprotocol", NULL, 12);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_10);
		ZVAL_STRING(_10, "request_protocol", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _11);
		zephir_check_temp_parameter(_10);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_12, tools, "getrequestprotocol", NULL, 12);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_13, tools, "gethttphost", NULL, 10);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(url);
		ZEPHIR_CONCAT_VSV(url, _12, "://", _13);
		ZEPHIR_INIT_NVAR(_10);
		ZVAL_STRING(_10, "url", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, url);
		zephir_check_temp_parameter(_10);
		zephir_check_call_status();
	}
	...
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, modules);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _12);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	_17 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	zephir_array_fetch_string(&_7, _17, SL("framework"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 408 TSRMLS_CC);
	zephir_array_fetch_string(&_18, _7, SL("catalog"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 408 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(_10);
	ZVAL_STRING(_10, "catalog", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _18);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	_19 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	zephir_array_fetch_string(&_20, _19, SL("framework"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 409 TSRMLS_CC);
	zephir_array_fetch_string(&_21, _20, SL("datetime"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 409 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(_10);
	ZVAL_STRING(_10, "datetime", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _21);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	_22 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	zephir_array_fetch_string(&_23, _22, SL("mail"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 410 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(_10);
	ZVAL_STRING(_10, "mail", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _23);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	_24 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	zephir_array_fetch_string(&_25, _24, SL("pdf"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 411 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(_10);
	ZVAL_STRING(_10, "pdf", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _25);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	_26 = zephir_fetch_nproperty_this(this_ptr, SL("config"), PH_NOISY_CC);
	zephir_array_fetch_string(&_27, _26, SL("files"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 412 TSRMLS_CC);
	ZEPHIR_INIT_NVAR(_10);
	ZVAL_STRING(_10, "files", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _27);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
	_28 = zephir_fetch_nproperty_this(this_ptr, SL("container"), PH_NOISY_CC);
	ZEPHIR_INIT_NVAR(_10);
	ZVAL_STRING(_10, "container", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(NULL, parameters, "setparameter", NULL, 11, _10, _28);
	zephir_check_temp_parameter(_10);
	zephir_check_call_status();
...
PHP_METHOD(Phady_Core_Kernel, getRootDir) {
	...
	if (Z_TYPE_P(_0) == IS_NULL) {
		...
		zephir_array_fetch_string(&document_root, _SERVER, SL("DOCUMENT_ROOT"), PH_NOISY, "phady/core/kernel.zep", 427 TSRMLS_CC);
		...
		if (zephir_fast_count_int(document_root_spl TSRMLS_CC) > 0) {
			zephir_array_fetch_long(&_1, document_root_spl, 0, PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 430 TSRMLS_CC);
			ZEPHIR_INIT_VAR(_2);
			ZEPHIR_CONCAT_VS(_2, _1, "app");
			zephir_update_property_this(this_ptr, SL("rootDir"), _2 TSRMLS_CC);
		} else {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phady_exception_ce, "No found root directory.", "phady/core/kernel.zep", 432);
			return;
		}
	}
...
PHP_METHOD(Phady_Core_Kernel, setEnvironment) {
	...
	if (ZEPHIR_IS_STRING(environment, "dev")) {
		ZEPHIR_SINIT_VAR(_0);
		ZVAL_LONG(&_0, 32767);
		ZEPHIR_CALL_FUNCTION(NULL, "error_reporting", NULL, 13, &_0);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_STRING(&_0, "display_errors", 0);
		ZEPHIR_SINIT_VAR(_1);
		ZVAL_LONG(&_1, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "ini_set", NULL, 14, &_0, &_1);
		zephir_check_call_status();
...
PHP_METHOD(Phady_Core_Kernel, serialize) {
	...
	zephir_array_fast_append(_0, _1);
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 5, _0);
	zephir_check_call_status();
	RETURN_MM();
