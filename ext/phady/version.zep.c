...
ZEPHIR_INIT_CLASS(Phady_Version) {
	...
	ZEPHIR_REGISTER_CLASS(Phady, Version, phady, version, phady_version_method_entry, 0);
	 ...
	 * </code>
	 */
	zend_declare_class_constant_long(phady_version_ce, SL("VERSION_MAJOR"), 0 TSRMLS_CC);
	 ...
	 * </code>
	 */
	zend_declare_class_constant_long(phady_version_ce, SL("VERSION_MEDIUM"), 1 TSRMLS_CC);
	 ...
	 * </code>
	 */
	zend_declare_class_constant_long(phady_version_ce, SL("VERSION_MINOR"), 2 TSRMLS_CC);
	 ...
	 * </code>
	 */
	zend_declare_class_constant_long(phady_version_ce, SL("VERSION_SPECIAL"), 3 TSRMLS_CC);
	 ...
	 * </code>
	 */
	zend_declare_class_constant_long(phady_version_ce, SL("VERSION_SPECIAL_NUMBER"), 4 TSRMLS_CC);
...
PHP_METHOD(Phady_Version, get) {
	...
	zephir_array_fetch_long(&major, version, 0, PH_NOISY, "phady/version.zep", 121 TSRMLS_CC);
	ZEPHIR_OBS_VAR(medium);
	zephir_array_fetch_long(&medium, version, 1, PH_NOISY, "phady/version.zep", 122 TSRMLS_CC);
	ZEPHIR_OBS_VAR(minor);
	zephir_array_fetch_long(&minor, version, 2, PH_NOISY, "phady/version.zep", 123 TSRMLS_CC);
	ZEPHIR_OBS_VAR(special);
	zephir_array_fetch_long(&special, version, 3, PH_NOISY, "phady/version.zep", 124 TSRMLS_CC);
	...
	ZEPHIR_CALL_SELF(&suffix, "_getspecial", &_0, 141, special);
	zephir_check_call_status();
...
PHP_METHOD(Phady_Version, getId) {
	...
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(major);
	zephir_array_fetch_long(&major, version, 0, PH_NOISY, "phady/version.zep", 153 TSRMLS_CC);
	ZEPHIR_OBS_VAR(medium);
	zephir_array_fetch_long(&medium, version, 1, PH_NOISY, "phady/version.zep", 154 TSRMLS_CC);
	ZEPHIR_OBS_VAR(minor);
	zephir_array_fetch_long(&minor, version, 2, PH_NOISY, "phady/version.zep", 155 TSRMLS_CC);
	ZEPHIR_OBS_VAR(special);
	zephir_array_fetch_long(&special, version, 3, PH_NOISY, "phady/version.zep", 156 TSRMLS_CC);
	ZEPHIR_OBS_VAR(specialNumber);
	zephir_array_fetch_long(&specialNumber, version, 4, PH_NOISY, "phady/version.zep", 157 TSRMLS_CC);
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_STRING(&_0, "%02s", 0);
	ZEPHIR_CALL_FUNCTION(&_1, "sprintf", &_2, 23, &_0, medium);
	zephir_check_call_status();
	ZEPHIR_SINIT_NVAR(_0);
	ZVAL_STRING(&_0, "%02s", 0);
	ZEPHIR_CALL_FUNCTION(&_3, "sprintf", &_2, 23, &_0, minor);
	zephir_check_call_status();
...
PHP_METHOD(Phady_Version, getPart) {
	...
	do {
		if (part == 0 || part == 1 || part == 2 || part == 4) {
			...
			zephir_array_fetch_long(&result, version, part, PH_NOISY, "phady/version.zep", 182 TSRMLS_CC);
			break;
		}
		if (part == 3) {
			zephir_array_fetch_long(&_1, version, 3, PH_NOISY | PH_READONLY, "phady/version.zep", 186 TSRMLS_CC);
			ZEPHIR_CALL_SELF(&result, "_getspecial", &_0, 141, _1);
			zephir_check_call_status();
			break;
		}
