...
PHP_METHOD(Phady_Util_DateTime, getDateByLanguage) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, 6);
	ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 72, &_0, language);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_3, "strftime", NULL, 73, format, _2);
	zephir_check_call_status();
	zephir_ucfirst(_1, _3);
	ZEPHIR_RETURN_CALL_FUNCTION("utf8_encode", NULL, 74, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_DateTime, getDateMoment) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("utf8_decode", NULL, 75, dayStr);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_DateTime, getWeekdaysInMonth) {
	...
	if (ZEPHIR_GE_LONG(_4, _3)) {
		while (1) {
			...
			ZVAL_LONG(&_9, year);
			ZEPHIR_CALL_FUNCTION(&time, "mktime", &_10, 76, &_5, &_6, &_7, &_8, i, &_9);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&tDate, "getdate", &_11, 77, time);
			zephir_check_call_status();
