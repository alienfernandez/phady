...
PHP_METHOD(Phady_Util_Tools, getMemoryLimit) {
	...
	ZEPHIR_CALL_FUNCTION(&memory_limit, "ini_get", NULL, 158, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "print_r", NULL, 106, memory_limit);
	zephir_check_call_status();
...
PHP_METHOD(Phady_Util_Tools, getOctets) {
	...
	if (zephir_is_true(_1)) {
		...
		ZEPHIR_CALL_FUNCTION(&_11, "preg_replace", NULL, 145, _9, _10, option);
...
PHP_METHOD(Phady_Util_Tools, getHostName) {
	...
	ZEPHIR_CALL_FUNCTION(&computerName, "getenv", NULL, 159, &_0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "gethostname", NULL, 160);
	zephir_check_call_status();
