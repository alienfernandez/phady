	...
	if (_0) {
		...
		if (first == 0) {
			if (Z_TYPE_P(posResultQuery) != IS_NULL) {
				...
				ZEPHIR_CALL_FUNCTION(&strQuery, "preg_replace", &_9, 65, _7, _8, text);
			...
			if (ZEPHIR_IS_LONG(posResultQuery, 0)) {
				...
				ZEPHIR_INIT_VAR(_11);
				ZVAL_LONG(_11, 1);
				ZEPHIR_CALL_FUNCTION(&strQuery, "preg_replace", &_9, 65, _7, _8, text, _11);
				zephir_check_call_status();
			} else {
...
PHP_METHOD(Phady_Util_Text, findAndReplaceUrlTags) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "preg_replace", &_3, 65, _0, _1, sanitate);
...
PHP_METHOD(Phady_Util_Text, snakeToCamel) {
	...
	if (_1 <= _2) {
		while (1) {
			...
			ZEPHIR_CALL_FUNCTION(&_6, "mb_strtoupper", &_7, 70, _5);
			zephir_check_call_status();
			ZEPHIR_SINIT_NVAR(_8);
			ZVAL_LONG(&_8, 1);
			ZEPHIR_CALL_FUNCTION(&_9, "mb_substr", &_10, 71, p, &_8);
			zephir_check_call_status();
...
PHP_METHOD(Phady_Util_Text, camelToSnake) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "preg_replace", NULL, 65, _0, _1, camel);
	zephir_check_temp_parameter(_0);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtolower", NULL, 72, _2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_Text, toUpper) {
	...
	if (Z_TYPE_P(encoding) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&enc, "mb_internal_encoding", NULL, 67);
		zephir_check_call_status();
	}
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtoupper", NULL, 70, text, enc);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_Text, toLower) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtolower", NULL, 72, text, enc);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_Text, upperCaseFirst) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, 2);
	ZEPHIR_CALL_FUNCTION(&newText, "mb_convert_case", &_1, 73, text, &_0, enc);
	zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_3, &_2)
		...
		ZVAL_LONG(&_0, 2);
		ZEPHIR_CALL_FUNCTION(&_6, "mb_convert_case", &_1, 73, e, &_0, enc);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_0);
		ZVAL_LONG(&_0, 1);
		ZEPHIR_CALL_FUNCTION(&_7, "mb_convert_case", &_1, 73, e, &_0, enc);
		zephir_check_call_status();
...
PHP_METHOD(Phady_Util_Text, countInstances) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mb_substr_count", NULL, 74, haystack, needle);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_Text, stripos) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mb_strtoupper", &_1, 70, haystack);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "mb_strtoupper", &_1, 70, needle);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, offset);
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strpos", NULL, 75, _0, _2, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phady_Util_Text, left) {
	...
	ZEPHIR_CALL_FUNCTION(&len, "mb_strlen", NULL, 76, text);
	zephir_check_call_status();
	if (ZEPHIR_GT_LONG(len, left)) {
		...
		ZEPHIR_SINIT_VAR(_1);
		ZVAL_LONG(&_1, left);
		ZEPHIR_CALL_FUNCTION(&_2, "mb_substr", NULL, 71, text, &_0, &_1);
		zephir_check_call_status();
