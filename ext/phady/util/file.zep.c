...
PHP_METHOD(Phady_Util_File, downloadFile) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_file", NULL, 84, path);
	...
	if (zephir_is_true(_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "header", &_3, 85, _5);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_4);
		ZVAL_STRING(&_4, "Content-Transfer-Encoding: binary", 0);
		ZEPHIR_CALL_FUNCTION(NULL, "header", &_3, 85, &_4);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_6, "filesize", NULL, 86, path);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_7);
		ZEPHIR_CONCAT_SV(_7, "Content-Length: ", _6);
		ZEPHIR_CALL_FUNCTION(NULL, "header", &_3, 85, _7);
		zephir_check_call_status();
		ZEPHIR_SINIT_NVAR(_4);
		ZVAL_STRING(&_4, "Accept-Ranges: bytes", 0);
		ZEPHIR_CALL_FUNCTION(NULL, "header", &_3, 85, &_4);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "readfile", NULL, 87, path);
		zephir_check_call_status();
