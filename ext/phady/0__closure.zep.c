...
PHP_METHOD(phady_0__closure, __invoke) {
	...
	ZEPHIR_CALL_METHOD(NULL, routeCore, "__construct", NULL, 141);
	zephir_check_call_status();
	zephir_array_fetch_string(&_0, _SERVER, SL("rootDirOk"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 264 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, routeCore, "setsystemroutes", NULL, 142, _0);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(routeCore, "getrouter", NULL, 143);
	zephir_check_call_status();
	RETURN_MM();
