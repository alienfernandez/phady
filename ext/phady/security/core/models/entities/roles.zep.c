...
PHP_METHOD(Phady_Security_Core_Models_Entities_Roles, init) {
	...
	ZEPHIR_CALL_PARENT(NULL, phady_security_core_models_entities_roles_ce, this_ptr, "init", &_0, 68);
	...
	Z_SET_ISREF_P(_1);
	ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_8, 69, _1, _2, _3, _4, _5, _6, _7);
	...
	ZVAL_STRING(_7, "init_path", ZEPHIR_TEMP_PARAM_COPY);
	Z_SET_ISREF_P(_9);
	ZEPHIR_CALL_FUNCTION(NULL, "array_push", &_8, 69, _9, _2, _3, _4, _5, _6, _7);
	zephir_check_temp_parameter(_2);
	zephir_check_temp_parameter(_3);
	zephir_check_temp_parameter(_4);
	zephir_check_temp_parameter(_5);
