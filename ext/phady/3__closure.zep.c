...
PHP_METHOD(phady_3__closure, __invoke) {
	...
	ZEPHIR_CALL_METHOD(NULL, routeCore, "__construct", NULL, 158);
	zephir_check_call_status();
	zephir_array_fetch_string(&_0, _SERVER, SL("rootDirOk"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 282 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, routeCore, "setsystemroutes", NULL, 159, _0);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(routeCore, "getrouter", NULL, 160);
	zephir_check_call_status();
	RETURN_MM();
