...
PHP_METHOD(phady_3__closure, __invoke) {
	...
	/* try_start_1: */
		...
		zephir_array_fetch_string(&_0, _SERVER, SL("configApp"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 306 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, dbCore, "__construct", NULL, 141, _0);
