...
PHP_METHOD(phady_2__closure, __invoke) {
	...
	/* try_start_1: */
		...
		zephir_array_fetch_string(&_0, _SERVER, SL("configApp"), PH_NOISY | PH_READONLY, "phady/core/kernel.zep", 289 TSRMLS_CC);
		ZEPHIR_CALL_METHOD(NULL, dbCore, "__construct", NULL, 105, _0);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_RETURN_CALL_METHOD(dbCore, "getadapter", NULL, 106);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM();
